  ...
  <worldbody>
    ...
    <body name="hand" childclass="panda" quat="{quaternion}" pos="{position}">
      ...
      <body name="left_finger" pos="0 0 0.0584">
        ...
        <geom type="mesh" mesh="gelsight_shell" material="black" pos="0 0.005 0.04" quat="0 0.707 0 0.707" condim="6" mass="0.03" solimp="0.09 0.95 0.001 0.5 2" solref="1 1" name="col_gelsight_left"/>
        <geom type="box" size="0.01 0.001 0.01" pos="0 -0.01324 0.04" priority="1" rgba="0 1 0 0.3" contype="1" conaffinity="1" name="hard_stop_left" solimp="0.99 0.99 0.001" solref="0.001 1" condim="3"/>
      ...
      <body name="right_finger" pos="0 -0.04 0.0584" quat="0 0 0 1">
        ...
        <geom type="mesh" mesh="gelsight_shell" material="black" pos="0 0.005 0.04" quat="0 0.707 0 0.707" condim="6" mass="0.03" solimp="0.09 0.95 0.001 0.5 2" solref="1 1" rgba="1 0 0 0.5" name="col_gelsight_right"/>
        <geom type="box" size="0.01 0.001 0.01" pos="0 -0.01324 0.04" priority="1" rgba="0 1 0 0.3" contype="1" conaffinity="1" name="hard_stop_right" solimp="0.99 0.99 0.001" solref="0.001 1" condim="3"/>
